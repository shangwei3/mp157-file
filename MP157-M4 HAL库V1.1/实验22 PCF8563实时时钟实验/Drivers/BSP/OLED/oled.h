...
#define OLED_SPI_RST_PIN                GPIO_PIN_1
#define OLED_SPI_RST_CLK_ENABLE()       do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PE口时钟使能 */
...
#define OLED_SPI_RS_PIN                 GPIO_PIN_11
#define OLED_SPI_RS_CLK_ENABLE()        do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PA口时钟使能 */

#define OLED_SPI_SCLK_PORT              GPIOH
#define OLED_SPI_SCLK_PIN               GPIO_PIN_9
#define OLED_SPI_SCLK_CLK_ENABLE()      do{ __HAL_RCC_GPIOH_CLK_ENABLE(); }while(0)   /* PH口时钟使能 */

#define OLED_SPI_SDIN_PORT              GPIOH
#define OLED_SPI_SDIN_PIN               GPIO_PIN_10
#define OLED_SPI_SDIN_CLK_ENABLE()      do{ __HAL_RCC_GPIOH_CLK_ENABLE(); }while(0)   /* PH口时钟使能 */
